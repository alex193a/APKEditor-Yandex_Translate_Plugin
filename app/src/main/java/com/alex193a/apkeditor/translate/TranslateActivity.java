...
public class TranslateActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private AppCompatButton stopOrSaveBtn;
    ...
    private void initView(List<TranslateItem> strings) {
        ...
        this.stopOrSaveBtn = (AppCompatButton) this.findViewById(R.id.btn_stop_or_save);
    ...
    protected View createStringView(TranslateItem item) {
        ...
        int itemLayoutId = R.layout.item_stringvalue_translate;
